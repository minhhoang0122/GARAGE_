            ...
            <div className="max-w-[210mm] mx-auto bg-white min-h-[297mm] p-8 relative print-content">
                ...
                <div className="flex justify-between items-start mb-8 border-b border-gray-300 pb-4">
                    <div>
                        ...
                        <p className="text-sm text-gray-600">Mã phiếu: <span className="font-mono font-bold">{data.code}</span></p>
                        <p className="text-sm text-gray-600">Ngày nhập: {formatDate(data.date)}</p>
                    </div>
                    <div className="text-right">
                        <h2 className="text-xl font-bold uppercase text-gray-800">Gara Master</h2>
                ...
                <table className="w-full mb-8 text-sm border-collapse">
                    ...
                    <tfoot>
                        <tr>
                            <td colSpan={5} className="py-2 px-1 text-right font-bold uppercase">Tiền hàng:</td>
                            <td className="py-2 px-1 text-right font-bold">{formatCurrency(data.total - (data.vat || 0))}</td>
                        </tr>
                        <tr>
                            <td colSpan={5} className="py-2 px-1 text-right font-bold uppercase">Thuế VAT:</td>
                            <td className="py-2 px-1 text-right font-bold">{formatCurrency(data.vat || 0)}</td>
                        </tr>
                        <tr className="border-t-2 border-gray-800">
                            <td colSpan={5} className="py-4 px-1 text-right font-bold uppercase">Tổng Thanh Toán:</td>
                            <td className="py-4 px-1 text-right font-bold text-lg">{formatCurrency(data.total)}</td>
                        </tr>
                    </tfoot>
                </table>
                    ...
                    <tbody>
                        <tr>
                            <td className="align-top pb-20 w-1/3">
                                <p className="font-bold uppercase mb-2">Người Lập Phiếu</p>
                                <p className="text-sm italic text-transparent">.</p>
                            </td>
                            <td className="align-top pb-20 w-1/3">
                                <p className="font-bold uppercase mb-2">Thủ Kho</p>
                                <p className="text-sm italic text-transparent">.</p>
                            </td>
                            <td className="align-top pb-20 w-1/3">
                                <p className="font-bold uppercase mb-2">Giám Đốc</p>
                                <p className="text-sm italic text-transparent">.</p>
                            </td>
                        </tr>
                        <tr>
